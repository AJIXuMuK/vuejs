<template>
    <div :class="$style.ImageViewerWebPart">
        <div :class="$style.container">
            <div :class="$style.row">
                <div :class="$style.column">
                    <span :class="$style.title">Image Url Web Part</span>
                    <p :class="$style.subTitle">Image Url is:</p>
                    <p :class="$style.description">{{imageUrl}}</p>
                </div>
            </div>
        </div>
    </div>
